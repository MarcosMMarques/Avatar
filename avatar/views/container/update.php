...
$this->title =
    "Atualizar Contâiner: " . $data["NOMECON"] . "/" . $data["SIGLACON"];
$this->params["breadcrumbs"][] = ["label" => "Contâiners", "url" => ["index"]];
$this->params["breadcrumbs"][] = "Atualizar";
$url =
    "index.php?r=container/update&nome=" .
    $data["NOMECON"] .
    "&sigla=" .
    $data["SIGLACON"] .
    "&tipo=" .
        ...
        <form method="post" action=<?= $url ?>>
                ...
                <select class="form-control" id="colonia" name="colonia" required>
                    ...
                    <?php foreach ($colonias as $colonia): ?>
                        <option value="<?= Html::encode(
                            ...
                            <?= $data["NOMECOL"] == $colonia["NOME"] &&
                            $data["UNIDADECOL"] == $colonia["UNIDADE"]
                                ? "selected"
                                : "" ?>>
                            <?= Html::encode(
                                "Nome: " .
            ...
            <?php if ($tipo == "residencia"): ?>
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="qtdbanheiros" name="qtdbanheiros" value="<?= Html::encode(
                        $data["QTDBANHEIROS"]
                    ) ?>" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="qtdcamas" name="qtdcamas" value="<?= Html::encode(
                        $data["QTDCAMAS"]
                    ) ?>" required>
                </div>
            <?php endif; ?>
            ...
            <?php if ($tipo == "deposito"): ?>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="tipomaterial" name="tipomaterial" value="<?= Html::encode(
                        $data["TIPOMATERIAL"]
                    ) ?>" required>
                </div>
            <?php endif; ?>
            ...
            <?php if ($tipo == "laboratorio"): ?>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="finalidade" name="finalidade" value="<?= Html::encode(
                        $data["FINALIDADE"]
                    ) ?>" required>
                </div>
            <?php endif; ?>
